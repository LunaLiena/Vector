...
import { Magnifier, Xmark, Stopwatch, CircleXmark, Clock, Briefcase,Check,Ban } from '@gravity-ui/icons';
...
export const ReadTasks = () => {
  ...
  const StatusIconRenderer = useCallback((params: ICellRendererParams<Task>) => {
